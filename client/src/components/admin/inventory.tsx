...
import { removeProduct, setPageNumber } from "../../app/store/catalog.slice";
...
export default function Inventory() {
  const { data, metaData } = useProducts();
